...
namespace YasuoBuddy
{
    class StateManager
    {
        ...
        public static void Harass()
        {
            ...
            if (Player.Instance.HasWhirlwind() || TargetSelector.SelectedTarget == target) return;
        ...
        {
            var minion = EntityManager.MinionsAndMonsters.GetLaneMinions().Where(a => a.Distance(Player.Instance) > 300 < 475).OrderBy(a => a.Health).FirstOrDefault();
            if (minion == null) return;
